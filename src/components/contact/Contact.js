...
const Contact = () => {
  ...
  useEffect(() => {
    emailjs.init('1_N2KyWV84aQJDIiH'); 
  }, []);
  ...
  const handleSend = (e) => {
    ...
    if (username === "") {
      ...
      emailjs.send('service_xv6hf0r', 'template_ybjmxzl', {
        from_name: username,
        from_email: email,
        to_name: "Shahbaz Ahmed",
            ...
            <form className="w-full flex flex-col gap-4 lgl:gap-6 py-2 lgl:py-5" onSubmit={handleSend}>
              ...
              <div className="flex flex-col gap-4">
                ...
                <input
                  onChange={(e) => setSubject(e.target.value)}
                  value={subject}
                  className={`${errMsg === "Please provide your Subject!" && "outline-designColor"} contactInput`}
                  type="text"
                />
              </div>
              <div className="flex flex-col gap-4">
